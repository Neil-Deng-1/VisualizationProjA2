...
const categories = {
    "Number of children born to parents at a given income percentile by race" : ["Native American", "Asian", "Black", "Hispanic", "White"],
    "Mean child family (household) income rank for children with mothers born in the U.S. by race and by gender" : ["Native American", "Asian", "Black", "Hispanic", "White"],
    "Percentage of children with college attendance by race and gender" : ["Black Female", "Black Male", "White Female", "White Male"],
    "Mean number of weekly working hours over the past year by race and gender" : ["Black Female", "Black Male", "White Female", "White Male"],
    "Percentage of children incarcerated by race and gender." : ["Black Female", "Black Male", "White Female", "White Male"],
    "Percentage of children married by race." : ["Black Female", "Black Male", "White Female", "White Male"],
    "Percentage of children employed at age 30 or older by race and gender" : ["Black Female", "Black Male", "White Female", "White Male"],
    "Mean wage rank of children at age 30 or older by race and gender" : ["Black Female", "Black Male", "White Female", "White Male"],
    "Mean child individual income rank by race and gender." : ["Black Female", "Black Male", "White Female", "White Male"],
    "Mean child individual income rank for children with single parents; by race and gender" : ["Black Male1", "White Male1", "Black Male2", "White Male2"],
    "Mean individual income rank of spouse by race and gender" : ["Black Female", "Black Male", "White Female", "White Male"]
};
...
function updateAxes(){
    ...
    svg.append("text")
        ...
        .text( function(){
            if(xVar == 'Number of children born to parents at a given income percentile by race'){
                return 'number'
            }else{
                return 'percent'
            }
